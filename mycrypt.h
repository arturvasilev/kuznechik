...
int MSB(uint8_t cc);
void MAC(uint8_t key_t[32], std::vector<uint8_t> input, uint8_t output[8]);
//void MAC(uint8_t key_t[32], std::vector<bool> input, uint8_t output[8]);
int crypt(uint8_t key_t[32], std::vector<uint8_t> input, std::vector<uint8_t> &output, uint8_t cmac[8]);
